...
namespace Mageleven\Core\Model\Config\Structure;

use Magento\Config\Model\Config\Structure\Data as StructureData;
use Mageleven\Core\Block\Adminhtml\System\Config\Button;
use Mageleven\Core\Block\Adminhtml\System\Config\Docs;
use Mageleven\Core\Block\Adminhtml\System\Config\Form\Field\Version;
use Mageleven\Core\Block\Adminhtml\System\Config\Message;
use Mageleven\Core\Helper\Validate as Helper;

/**
 * Plugin to add 'Module Information' group to each modules (before general group)
 *
 * Class Data
 * @package Mageleven\Core\Model\Config\Structure
 */
class Data
{
    /**
    ...
    public function beforeMerge(StructureData $object, array $config)
    {
        ...
        foreach ($sections as $sectionId => $section) {
            if (isset($section['tab']) && ($section['tab'] === 'mageleven') && ($section['id'] !== 'mageleven')) {
    ...
    protected function getFieldList()
    {
        return [
            ...
            'name'        => [
                ...
                'frontend_class' => 'mageleven-module-active-field-free mageleven-module-active-name',
                'show'           => Helper::MODULE_TYPE_FREE
            ],
            'email'       => [
                'label'          => __('Register Email'),
                'validate'       => 'required-entry validate-email',
                'frontend_class' => 'mageleven-module-active-field-free mageleven-module-active-email',
                'comment'        => __('This email will be used to create a new account at Mageleven.com, Mageleven help desk (to get priority support).'),
                'show'           => Helper::MODULE_TYPE_FREE
            ],
            'product_key' => [
                'label'          => __('Product Key'),
                'frontend_class' => 'mageleven-module-active-field-key',
                'show'           => Helper::MODULE_TYPE_FREE
            ],
            'button'      => [
