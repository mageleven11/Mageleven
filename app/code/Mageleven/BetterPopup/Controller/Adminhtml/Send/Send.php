...
namespace Mageleven\BetterPopup\Controller\Adminhtml\Send;
...
use Mageleven\BetterPopup\Block\Email\Template;
use Mageleven\BetterPopup\Helper\Data as HelperData;
use Psr\Log\LoggerInterface;

/**
 * Class Send
 * @package Mageleven\BetterPopup\Controller\Adminhtml\Send
 */
class Send extends Action
{
    ...
    /**
     * @var /Mageleven\BetterPopup\Helper\Data
     */
    ...
    public function sendMail($store)
    {
        ...
        $transport = $this->_transportBuilder
            ->setTemplateIdentifier('mageleven_betterpopup_template')
            ->setTemplateOptions([
