...
use Mageleven\BetterPopup\Model\Config\Source\Appear;
use Mageleven\BetterPopup\Model\Config\Source\PageToShow;
use Mageleven\BetterPopup\Model\Config\Source\Responsive;
...
class Popup extends AbstractProduct implements BlockInterface
{
    ...
    public function getPopupContent()
    {
        ...
        $replace = [
            ...
            $this->getViewFileUrl('Mageleven_BetterPopup::images/mail-icon.png'),
            $this->getViewFileUrl('Mageleven_BetterPopup::images/bg-tmp2.png'),
            $this->getViewFileUrl('Mageleven_BetterPopup::images/template3/img-content.png'),
            $this->getViewFileUrl('Mageleven_BetterPopup::images/template3/button-icon.png'),
            $this->getViewFileUrl('Mageleven_BetterPopup::images/template4/bg.png'),
            $this->getViewFileUrl('Mageleven_BetterPopup::images/template4/img-content.png'),
            $this->getViewFileUrl('Mageleven_BetterPopup::images/template5/img-content.png'),
            $this->getViewFileUrl('Mageleven_BetterPopup::images/template5/img-cap.png'),
            $this->getViewFileUrl('Mageleven_BetterPopup::images/template5/img-email.png')
        ];
    ...
    public function getAjaxData()
    {
        $params = [
            ...
            'srcCloseIconWhite'  => $this->getViewFileUrl('Mageleven_BetterPopup::images/icon-close-white.png')
        ];
