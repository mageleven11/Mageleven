...
define([
    ...
    $.widget('mageleven.betterpopup_block', {
        options: {
            dataPopup: {}
        },
        ...
        _showPopup: function () {
            var self = this,
                popupElem = $('.mageleven-betterpopup-block').length,
        ...
        _removeDuplicatePopup: function () {
            $('[id]').each(function () {
                $('[id="mageleven-betterpopup-block"]:gt(0)').remove();
            });
        },
    ...
    return $.mageleven.betterpopup_block;
});
