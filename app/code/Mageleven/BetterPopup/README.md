...
[![Latest Stable Version](https://poser.pugx.org/mageleven/module-better-popup/v/stable)](https://packagist.org/packages/mageleven/module-better-popup)
[![Total Downloads](https://poser.pugx.org/mageleven/module-better-popup/downloads)](https://packagist.org/packages/mageleven/module-better-popup)
...
- [User guide](https://docs.mageleven.com/better-popup/index.html)
- [Introduction page](http://www.mageleven.com/magento-2-better-popup/)
- [Contribute on Github](https://github.com/mageleven/magento-2-better-popup)
- [Get Support](https://github.com/mageleven/magento-2-better-popup/issues)

## 2. Better Popup FAQs

**Q: I got error: Mageleven_Core has been already defined**

A: Read solution [here](https://github.com/mageleven/module-core/issues/3)
...
A: To see a full report on dashboard, you can integrate the [free Reports extension by Mageleven](https://www.mageleven.com/magento-2-reports-extension/).
...
```
composer require mageleven/module-better-popup mageleven/module-smtp
...
```
composer require mageleven/module-better-popup
php bin/magento setup:upgrade
php bin/magento setup:static-content:deploy
```
...
Admins can create a new template, use or customize Mageleven’s premade pop-up designs:
...
There are 3 pre-made pop-up templates with 2 main display styles which are ready to use. Admins are free to change these templates or use them after installing **[Magento 2 Popup extension](https://marketplace.magento.com/mageleven-module-better-popup.html)**.
...
If your store also install [Mageleven Reports extension free module](https://www.mageleven.com/magento-2-reports-extension/), a widget will be inserted into the admin dashboard which show a full report on your subscribers.

### SMTP compatibility

The new-subscriber report emails function is compatible with [Magento 2 SMTP by Mageleven](https://www.mageleven.com/magento-2-smtp/). This helps guarantee of spam-free emails.
...
- Display the Terms and Conditions checkbox ([GDPR compliance](https://www.mageleven.com/magento-2-gdpr-extension/))
...
To start the configuration, from the Admin Panel, make your way to **Store > Settings > Configuration > Mageleven Extensions > Better Popup**
...
- [Magento 2 google maps](https://github.com/mageleven/magento-2-google-maps)
- [Magento 2 GDPR](https://github.com/mageleven/magento-2-gdpr)
- [Magento 2 Multiple Flat Rates Shipping](https://github.com/mageleven/magento-2-multi-flat-rates)
- [Magento 2 Report extension](https://github.com/mageleven/magento-2-reports)
- [Magento 2 social login](https://github.com/mageleven/magento-2-social-login)
- [Magento 2 blog extension](https://github.com/mageleven/magento-2-blog)
- [Magento 2 Layered Navigation](https://github.com/mageleven/magento-2-ajax-layered-navigation)
- [Magento 2 shared cart](https://github.com/mageleven/magento-2-share-cart)
- [Magento 2 SMTP](https://github.com/mageleven/magento-2-smtp)

**[Our extensions on Marketplace](https://marketplace.magento.com/partner/Mageleven):**
- [Magento 2 Ajax Search](https://marketplace.magento.com/mageleven-module-search.html)
- [Magento 2 Image Optimizer](https://marketplace.magento.com/mageleven-module-image-optimizer.html)
- [Magento 2 Quick Order](https://marketplace.magento.com/mageleven-module-quick-order.html)
- [Magento 2 Product Feed](https://marketplace.magento.com/mageleven-module-product-feed.html)
- [Magento 2 Gift Wrap](https://marketplace.magento.com/mageleven-module-gift-wrap.html)
- [Magento 2 Product Options](https://marketplace.magento.com/mageleven-module-better-product-options.html)
- [Magento 2 Custom Order Number](https://marketplace.magento.com/mageleven-module-custom-order-number.html)
- [Magento 2 Product Attachments](https://marketplace.magento.com/mageleven-module-product-attachments.html)
