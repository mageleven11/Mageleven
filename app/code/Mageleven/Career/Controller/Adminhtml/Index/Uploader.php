...
namespace Mageleven\Career\Controller\Adminhtml\Index;
...
class Uploader extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'thumb/image/';
            if (!is_dir($mediaRootDir)) {
                $this->fileIo->mkdir($mediaRootDir, 0777);
            }
            ...
            $imageResult['url'] = $mediaUrl . 'thumb/image/' . $newImageName;
        } catch (\Exception $e) {
