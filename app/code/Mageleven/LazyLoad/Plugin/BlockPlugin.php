...
namespace Mageleven\LazyLoad\Plugin;
...
class BlockPlugin
{
    const LAZY_TAG = '<!-- MAGELEVEN_LAZY_LOAD -->';
     ...
     * Lazy store config
     *
     * @var \Mageleven\LazyLoad\Model\Config
     */
    protected $config;
    ...
    private function prepareForJsLazyLoad($block, string $html): string
    {
        ...
        $pixelSrc = ' src="' . $block->getViewFileUrl('Mageleven_LazyLoad::images/pixel.jpg') . '"';
        $tmpSrc = 'TMP_SRC';
