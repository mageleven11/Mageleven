...
use Mageleven\AutoRelatedProduct\Api\Data\RuleInterfaceFactory;
use Mageleven\AutoRelatedProduct\Api\Data\RuleSearchResultsInterfaceFactory;
use Mageleven\AutoRelatedProduct\Api\RuleRepositoryInterface;
use Mageleven\AutoRelatedProduct\Api\RelatedResourceModelInterface as ResourceRule;
use Mageleven\AutoRelatedProduct\Api\RelatedCollectionInterfaceFactory as RuleCollectionFactory;
...
class RuleRepository implements RuleRepositoryInterface
{
     ...
     */
    public function save(\Mageleven\AutoRelatedProduct\Api\Data\RuleInterface $rule)
    {
        try {
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        $this->extensionAttributesJoinProcessor->process(
            $collection,
            \Mageleven\AutoRelatedProduct\Api\Data\RuleInterface::class
        );
     ...
     */
    public function delete(\Mageleven\AutoRelatedProduct\Api\Data\RuleInterface $rule)
    {
        try {
