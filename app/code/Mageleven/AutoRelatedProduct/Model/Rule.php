...
class Rule extends \Magento\Framework\Model\AbstractModel implements \Mageleven\AutoRelatedProduct\Api\Data\RuleInterface
{
    /**
     * Rule's Status
     */
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageleven_arp_rule';
    ...
    {
        $this->_init(\Mageleven\AutoRelatedProduct\Api\RelatedResourceModelInterface::class);
    }
