...
namespace Mageleven\AutoRelatedProduct\Model\ResourceModel;
...
use Mageleven\AutoRelatedProduct\Api\RelatedResourceModelInterface;
...
class Rule extends AbstractDb implements RelatedResourceModelInterface
{
    ...
    {
        $this->_init('mageleven_autorp_rule', 'id');
    }
    ...
    {
        return $this->_lookupIds($ruleId, 'mageleven_autorp_rule_store', 'store_id');
    }
    ...
    protected function _afterSave(AbstractModel $object)
    {
        ...
        $this->_updateLinks($object, $newIds, $oldIds, 'mageleven_autorp_rule_store', 'store_id');
    ...
    {
        $result =$this->_lookupIds($object->getId(), 'mageleven_autorp_index', 'related_ids');
