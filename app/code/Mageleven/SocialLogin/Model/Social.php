...
namespace Mageleven\SocialLogin\Model;
 ...
 * Class Social
 *
 * @package Mageleven\SocialLogin\Model
 */
class Social extends AbstractModel
{
    ...
    /**
     * @type \Mageleven\SocialLogin\Helper\Social
     */
    protected $apiHelper;
     ...
     * @param \Mageleven\SocialLogin\Helper\Social $apiHelper
    ...
    public function __construct(
        ...
        \Mageleven\SocialLogin\Helper\Social $apiHelper,
        User $userModel,
        DateTime $dateTime,
    ...
    protected function getAdapter($type)
    {
        ...
        if (isset($adapters[$type])) {
            return 'Mageleven\SocialLogin\Model\Providers' . "\\" . $adapters[$type];
        }
        $adaptersPro = [
            'pinterest'     => 'Pinterest',
        ...
        if (isset($adaptersPro[$type])) {
            return 'Mageleven\SocialLoginPro\Model\Providers' . "\\" . $adaptersPro[$type];
        }
