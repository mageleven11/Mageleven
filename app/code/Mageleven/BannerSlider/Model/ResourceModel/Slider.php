...
namespace Mageleven\BannerSlider\Model\ResourceModel;
...
use Mageleven\BannerSlider\Helper\Data as bannerHelper;
use Zend_Serializer_Exception;

/**
 * Class Slider
 * @package Mageleven\BannerSlider\Model\ResourceModel
 */
class Slider extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->sliderBannerTable = $this->getTable('mageleven_bannerslider_banner_slider');
    }
    ...
    {
        $this->_init('mageleven_bannerslider_slider', 'slider_id');
    }
     ...
     * after save callback
     *
     * @param AbstractModel|\Mageleven\BannerSlider\Model\Slider $object
     *
     * @return AbstractDb
     */
    ...
    /**
     * @param \Mageleven\BannerSlider\Model\Slider $slider
     *
     * @return array
     */
    public function getBannersPosition(\Mageleven\BannerSlider\Model\Slider $slider)
    {
     ...
     * @return $this
     */
    protected function saveBannerRelation(\Mageleven\BannerSlider\Model\Slider $slider)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageleven_bannerslider_slider_after_save_banners',
