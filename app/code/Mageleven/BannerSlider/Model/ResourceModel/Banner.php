...
class Banner extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->bannerSliderTable = $this->getTable('mageleven_bannerslider_banner_slider');
    }
    ...
    {
        $this->_init('mageleven_bannerslider_banner', 'banner_id');
    }
    ...
    /**
     * @param \Mageleven\BannerSlider\Model\Banner $banner
     *
     * @return $this
     */
    protected function saveSliderRelation(\Mageleven\BannerSlider\Model\Banner $banner)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageleven_bannerslider_banner_after_save_sliders',
     ...
     * @return array
     */
    public function getSliderIds(\Mageleven\BannerSlider\Model\Banner $banner)
    {
        $adapter = $this->getConnection();
        $select = $adapter->select()
