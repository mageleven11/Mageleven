...
namespace Mageleven\BannerSlider\Model;
...
use Mageleven\BannerSlider\Model\Config\Source\Image as configImage;
use Mageleven\BannerSlider\Model\ResourceModel\Banner as ResourceBanner;
use Mageleven\BannerSlider\Model\ResourceModel\Slider\Collection;
use Mageleven\BannerSlider\Model\ResourceModel\Slider\CollectionFactory as sliderCollectionFactory;
...
class Banner extends AbstractModel implements IdentityInterface
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mageleven_bannerslider_banner';
     ...
     * @var string
     */
    protected $_cacheTag = 'mageleven_bannerslider_banner';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageleven_bannerslider_banner';
    ...
    public function getSelectedSlidersCollection()
    {
        if ($this->sliderCollection === null) {
            ...
            $collection->getSelect()->join(
                ['banner_slider' => $this->getResource()->getTable('mageleven_bannerslider_banner_slider')],
