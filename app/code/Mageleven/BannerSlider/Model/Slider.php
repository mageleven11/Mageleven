...
class Slider extends AbstractModel implements IdentityInterface
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mageleven_bannerslider_slider';
     ...
     * @var string
     */
    protected $_cacheTag = 'mageleven_bannerslider_slider';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageleven_bannerslider_slider';
    ...
    {
        $this->_init('Mageleven\BannerSlider\Model\ResourceModel\Slider');
    }
