...
namespace Mageleven\BannerSlider\Setup;
...
use Mageleven\BannerSlider\Model\Config\Source\Template;
use Psr\Log\LoggerInterface;
use Zend_Db_Exception;

/**
 * Class InstallSchema
 * @package Mageleven\BannerSlider\Setup
 */
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('mageleven_bannerslider_banner')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageleven_bannerslider_banner'))
                ->addColumn(
                    'banner_id',
                    Table::TYPE_INTEGER,
                    null,
            ...
            $installer->getConnection()->addIndex(
                $installer->getTable('mageleven_bannerslider_banner'),
                $setup->getIdxName(
                    $installer->getTable('mageleven_bannerslider_banner'),
        ...
        if (!$installer->tableExists('mageleven_bannerslider_slider')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageleven_bannerslider_slider'))
                ->addColumn(
                    'slider_id',
                    Table::TYPE_INTEGER,
                    null,
        ...
        if (!$installer->tableExists('mageleven_bannerslider_banner_slider')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageleven_bannerslider_banner_slider'))
                ->addColumn(
                    'slider_id',
                    Table::TYPE_INTEGER,
                    null,
                ...
                ->addIndex($installer->getIdxName('mageleven_bannerslider_banner_slider', ['slider_id']), ['slider_id'])
                ->addIndex($installer->getIdxName('mageleven_bannerslider_banner_slider', ['banner_id']), ['banner_id'])
                ->addForeignKey(
                    $installer->getFkName(
                        'mageleven_bannerslider_banner_slider',
                        'slider_id',
                        'mageleven_bannerslider_slider',
                        'slider_id'
                    ),
                    'slider_id',
                    $installer->getTable('mageleven_bannerslider_slider'),
                    'slider_id',
    ...
    private function copyDemoImage()
    {
        try {
            ...
            $url = 'mageleven/bannerslider/banner/demo/';
