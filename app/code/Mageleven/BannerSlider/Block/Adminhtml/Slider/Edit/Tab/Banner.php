...
namespace Mageleven\BannerSlider\Block\Adminhtml\Slider\Edit\Tab;
...
use Mageleven\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\GridImage;
use Mageleven\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\Status;
use Mageleven\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\Type;
use Mageleven\BannerSlider\Model\BannerFactory;
use Mageleven\BannerSlider\Model\ResourceModel\Banner\Collection;
use Mageleven\BannerSlider\Model\ResourceModel\Banner\CollectionFactory as BannerCollectionFactory;

/**
 * Class Banner
 * @package Mageleven\BannerSlider\Block\Adminhtml\Slider\Edit\Tab
 */
class Banner extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('mageleven_bannerslider_banner_slider')],
    ...
    /**
     * @param \Mageleven\BannerSlider\Model\Banner|Object $item
     *
     * @return string
     */
