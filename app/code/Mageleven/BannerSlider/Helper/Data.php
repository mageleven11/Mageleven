...
namespace Mageleven\BannerSlider\Helper;
...
class Data extends AbstractData
{
    ...
    public function getBannerCollection($id = null)
    {
        ...
        $collection->join(
            ['banner_slider' => $collection->getTable('mageleven_bannerslider_banner_slider')],
    ...
    /**
     * @return \Mageleven\BannerSlider\Model\ResourceModel\Slider\Collection
     * @throws NoSuchEntityException
     */
    public function getActiveSliders()
    {
        /** @var \Mageleven\BannerSlider\Model\ResourceModel\Slider\Collection $collection */
