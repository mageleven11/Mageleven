...
[![Latest Stable Version](https://poser.pugx.org/mageleven/module-banner-slider/v/stable)](https://packagist.org/packages/mageleven/module-banner-slider)
[![Total Downloads](https://poser.pugx.org/mageleven/module-banner-slider/downloads)](https://packagist.org/packages/mageleven/module-banner-slider)

**IMPORTANT NOTE:** This version of Mageleven Banner Slider extension on Github is free as a contribution to the Magento community from Mageleven. This package does not include the technical support. Should you need technical support for this extension, you will have to buy a license from Mageleven. [Click here to buy](https://www.mageleven.com/magento-2-banner-slider-extension/).

## 1. Documentation

- [Installation guide](https://www.mageleven.com/install-magento-2-extension/)
- [User Guide](https://docs.mageleven.com/banner-slider-m2/)
- [Get Support](https://github.com/mageleven/magento-2-banner-slider/issues)
- [Download from our Live site](https://www.mageleven.com/magento-2-banner-slider-extension/)
...
```
composer require mageleven/module-banner-slider avada/module-proofo
...
```
composer require mageleven/module-banner-slider 
php bin/magento setup:upgrade
php bin/magento setup:static-content:deploy
```


### ✓ Install Package from Mageleven


- Download the latest version at [Mageleven Banner Slider for Magento 2](https://www.mageleven.com/magento-2-banner-slider-extension/)
-  [Installation guide](https://www.mageleven.com/install-magento-2-extension/)
...
A: Yes. We support 4 available templates that you can use for customization. Please set Advanced Type and select the demo template. See more information [Here](https://docs.mageleven.com/banner-slider-m2/index.html).

**Q: Can I create a Banner Slider Widget?**

A: Yes, you can create the widget by navigating to `Content > Elements > Widgets`, then set type as Banner Slider Widget and Design Theme. See more information [Here](https://docs.mageleven.com/banner-slider-m2/index.html).
...
Animation effects can considerably better the Sliders' appearance, and make them appealing to customers. Banner Slider module by Mageleven support 9 available slider effects including:
...
Login to the **Magento Admin**, navigate to `Store > Configuration > Mageleven > Banner Sliders`
...
- [Magento 2 Security Suite](https://github.com/mageleven/magento-2-security)
- [Magento 2 Maps extension](https://github.com/mageleven/magento-2-google-maps)
- [Magento 2 ReCaptcha extension](https://github.com/mageleven/magento-2-google-recaptcha)
...
**Get more [Magento 2 extensions on Marketplace](https://marketplace.magento.com/partner/Mageleven):**
- [M2 Reward Points](https://marketplace.magento.com/mageleven-module-reward-points.html)
- [M2 Affiliate Module](https://marketplace.magento.com/mageleven-module-affiliate.html)
- [M2 Product Feed](https://marketplace.magento.com/mageleven-module-product-feed.html)
- [M2 Custom Order Number](https://marketplace.magento.com/mageleven-module-custom-order-number.html)
- [M2 Multiple Coupons](https://marketplace.magento.com/mageleven-module-multiple-coupons.html)
- [M2 Import Export CMS](https://marketplace.magento.com/mageleven-module-import-export-cms.html)
- [Magento 2 Shipping Restrictions](https://marketplace.magento.com/mageleven-module-shipping-restriction.html)
- [Magento 2 Multiple Coupons](https://marketplace.magento.com/mageleven-module-multiple-coupons.html)
- [Magento 2 Order Attributes](https://marketplace.magento.com/mageleven-module-order-attributes.html)
- [Magento 2 Barcode](https://marketplace.magento.com/mageleven-module-barcode.html)
