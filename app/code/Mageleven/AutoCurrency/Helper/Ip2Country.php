...
class Ip2Country
{
    const MODULE_NAME = 'Mageleven_AutoCurrency';
    ...
    {
    if ($this->lastentry !== null && strlen($this->lastentry) === 10 && strcmp($ipbin, substr($this->lastentry, 0, 4)) >= 0 && strcmp($ipbin, substr($this->lastentry, 6, 4)) < 0) 
