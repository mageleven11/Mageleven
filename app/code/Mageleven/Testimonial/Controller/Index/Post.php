...
class Post extends \Magento\Framework\App\Action\Action
{
    ...
    public function __construct(
        ...
        \Mageleven\Testimonial\Helper\Data $moduleHelper
    ) {
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPostValue()) {
            ...
            if (isset($_FILES['image']) && isset($_FILES['image']['name']) && strlen($_FILES['image']['name'])) {
                 ...
                 * Save image upload
                 */
                $model = $this->_objectManager->create('Mageleven\Testimonial\Model\Testimonial');
                try {
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath('mageleven/testimonial/')
                    );
                    
                    $data['image'] = 'mageleven/testimonial/'.$result['file'];
