...
class ExportExcel extends \Mageleven\Testimonial\Controller\Adminhtml\Action
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Mageleven\Testimonial\Block\Adminhtml\Testimonial\Grid')->getExcel();
