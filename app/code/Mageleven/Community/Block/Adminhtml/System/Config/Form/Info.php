...
namespace Mageleven\Community\Block\Adminhtml\System\Config\Form;

use Mageleven\Community\Api\GetModuleVersionInterface;

/**
 * Admin Mageleven configurations information block
 */
class Info extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    public function __construct(
        ...
        $this->getModuleVersion = $getModuleVersion ?: \Magento\Framework\App\ObjectManager::getInstance()->get(
            \Mageleven\Community\Api\GetModuleVersionInterface::class
        );
    }
    ...
    {
        $useUrl = \Mageleven\Community\Model\UrlChecker::showUrl($this->getUrl());
        ...
        if ($useUrl) {
            $html .= '<a href="' . $this->escapeHtml($this->getModuleUrl()) . '" target="_blank">Mageleven</a>';
        } else {
            $html .= '<strong>Mageleven</strong>';
        }
        $html .= '.</div>';
