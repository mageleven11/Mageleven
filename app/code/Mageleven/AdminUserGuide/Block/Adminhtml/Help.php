 ...
 */
namespace Mageleven\AdminUserGuide\Block\Adminhtml;

use Magento\Framework\View\Element\Template;
use Mageleven\AdminUserGuide\Model\XmlReader;
use Mageleven\AdminUserGuide\Model\Config;
...
class Help extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $data = [];
        if (!$this->authorization->isAllowed('Mageleven_AdminUserGuide::help')) {
            return $data;
        }
