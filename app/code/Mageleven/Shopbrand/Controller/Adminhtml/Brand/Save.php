...
class Save extends \Mageleven\Shopbrand\Controller\Adminhtml\Action
{
    /**
            ...
            if (isset($_FILES['image']) && isset($_FILES['image']['name']) && strlen($_FILES['image']['name'])) {
                ...
                try {
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath('mageleven/shopbrand/brand/')
                    );
                    $data['image'] = 'mageleven/shopbrand/brand'.$result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
