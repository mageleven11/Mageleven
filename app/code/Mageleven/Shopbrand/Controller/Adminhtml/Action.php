<?php
namespace Mageleven\Shopbrand\Controller\Adminhtml;
...
abstract class Action extends \Magento\Backend\App\Action
{
     ...
     * @var string
     */
    // protected $_modelClass      = 'Mageleven\Shopbrand\Model\Shopbrand';
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed("Mageleven_Shopbrand::shopbrand_$action");
    }
}
