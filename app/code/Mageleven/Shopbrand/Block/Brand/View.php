...
namespace Mageleven\Shopbrand\Block\Brand;

use Magento\Framework\App\Filesystem\DirectoryList;

class View extends \Mageleven\Shopbrand\Block\Brand implements \Magento\Framework\DataObject\IdentityInterface
{

    const DEFAULT_CACHE_TAG = 'MAGELEVEN_BRAND_VIEW';
     ...
     * @return number
     */    
    public function getProductCount(\Mageleven\Shopbrand\Model\Shopbrand $brand)
    {
