...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        $message = __('Something went wrong with your account! Please contact us for more information.');
        return $this->getConfig('general/disapproval_message') ?: $message;
    }
     ...
     * @return string
     */
    public function getEmailAdminSender($storeId = null)
    {
        $default = 'magezon@gmail.comr';
        return $this->getConfig('admin_email_settings/email_sender', $storeId) ?: $default;
    }
     ...
     * @return string
     */
    public function getEmailCustomerSender($storeId = null)
    {
        $default = 'magezon@gmail.com';
        return $this->getConfig('customer_email_settings/email_sender', $storeId) ?: $default;
    }
    ...
    {
        $default = 'customerapproval_admin_email_settings_email_template';
        return $this->getConfig('admin_email_settings/email_template', $storeId) ?: $default;
    }
    ...
    {
        $default = 'customerapproval_customer_email_settings_approval_email_template';
        return $this->getConfig('customer_email_settings/approval_email_template', $storeId) ?: $default;
    }
    ...
    {
        $default = 'customerapproval_customer_email_settings_rejected_email_template';
        return $this->getConfig('customer_email_settings/rejected_email_template', $storeId) ?: $default;
    }
    ...
    {
        $default = 'customerapproval_customer_email_settings_pending_email_template';
        return $this->getConfig('customer_email_settings/pending_email_template', $storeId) ?: $default;
    }
