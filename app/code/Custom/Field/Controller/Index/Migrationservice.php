...
class Migrationservice extends Action
{
    ...
    public function execute()
    {
       ...
       // Send email
        ...
        try {
            $subject = 'Migration Services';

             // Send email to user
            $userTransport = $this->transportBuilder
                ->setTemplateIdentifier(27) // Use your custom email template ID here
            ...
            $adminTransport = $this->transportBuilder
                ->setTemplateIdentifier(15) // Use your custom email template ID here
                ->setTemplateOptions(['area' => \Magento\Framework\App\Area::AREA_FRONTEND, 'store' => $this->storeManager->getStore()->getId()])
                ->setTemplateVars([
                    'name' => $postData['development_name'],
                    'email' => $postData['email'],
