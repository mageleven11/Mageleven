...
class Upgradem2 extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            $subject = 'Upgrade M2 Services';

            // Send email to user
            $userTransport = $this->transportBuilder
                ->setTemplateIdentifier(24) // Use your custom email template ID here
            ...
            $adminTransport = $this->transportBuilder
                ->setTemplateIdentifier(14) // Use your custom email template ID here
                ->setTemplateOptions(['area' => \Magento\Framework\App\Area::AREA_FRONTEND, 'store' => $this->storeManager->getStore()->getId()])
                ->setTemplateVars([
                    'name' => $postData['development_name'],
                    'email' => $postData['email'],
