...
return [
    'modules' => [
        ...
        'Aureatelabs_ProductAttachment' => 1,
        'Custom_Field' => 1,
        'Custom_Installationservice' => 1,
        'Itheavens_Fanpage' => 1,
        'Itheavens_ImageUploader' => 1,
        'MageKey_CustomerRestriction' => 1,
        'Magecomp_Mobileloginfree' => 1,
        'Mageleven_AdminUserGuide' => 0,
        'Mageleven_AutoCurrency' => 0,
        'Mageleven_AutoRelatedProduct' => 0,
        'Mageleven_Core' => 1,
        'Mageleven_BetterPopup' => 1,
        'Mageleven_CancelOrder' => 0,
        'Mageleven_Community' => 1,
        'Mageleven_Contributors' => 1,
        'Mageleven_BannerSlider' => 0,
        'Mageleven_CustomerAvatar' => 0,
        'Mageleven_DeleteOrders' => 0,
        'Mageleven_Extensionidea' => 1,
        'Mageleven_Extrafee' => 0,
        'Mageleven_FreepriceLabel' => 1,
        'Mageleven_HtmlSitemap' => 0,
        'Mageleven_ImageOptimizer' => 0,
        'Mageleven_InfiniteScroll' => 0,
        'Mageleven_LazyLoad' => 0,
        'Mageleven_SeoTags' => 1,
        'Mageleven_Shopbrand' => 0,
        'Mageleven_SlickCarousel' => 0,
        'Mageleven_SocialLogin' => 0,
        'Mageleven_Testimonial' => 0,
        'Mageplaza_Core' => 1,
        'Mageplaza_Blog' => 1,
        'Mageplaza_Smtp' => 1,
        'Mageplaza_SocialLogin' => 1,
        'Mageplaza_Userguideslider' => 1,
        'Magezon_Core' => 1,
